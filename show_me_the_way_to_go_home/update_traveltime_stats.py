...
def main():
    ...
    write_result_to_stats_file(configuration, csv_row)


def write_result_to_stats_file(configuration, csv_row):
    create_stats_file_if_needed(configuration)
...
def create_stats_file_if_needed(configuration):
